...
# Create a fixed version of the image_generator.py file
...
def generate_product_image(product_name, keywords="", image_style="product", image_size="512x512"):
    ...
    try:
        ...
        def log_progress(step, timestep, latents):
            if step % 5 == 0:
                logger.info(f"Generation progress: Step {step+1}/30")
...
# Write the code to the image_generator.py file
file_path = r'd:\PI\product-description-generator-main\product-description-generator-main\generators\image_generator.py'
with open(file_path, 'w') as f:
    f.write(code)

print(f"Fixed file created at: {file_path}")
