...
def get_integer_input(prompt, min_val, max_val, default=None):
...
def main():
    ...
    while True:
        ...
        budget_amount = get_integer_input("Monthly Budget Amount ($): ", 0, 1000000, default=2000)
        daily_hours = get_integer_input("Daily Hours Available: ", 1, 24, default=8)
        technical_skill = get_integer_input("Technical Skills (1-5): ", 1, 5, default=3)
        audience_size = get_integer_input("Target Audience Size (1-5): ", 1, 5, default=3)
        goal = get_goal_input()
